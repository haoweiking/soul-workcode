...
TEST_MODULES = [
    'yiyun.tests.model.user',
    #
    # # rest unittest
    'yiyun.tests.rest.user',
    # 'yiyun.tests.rest.team',
    # 'yiyun.tests.rest.activity',
    'yiyun.tests.rest.order',
    'yiyun.tests.rest.match',
    'yiyun.tests.rest.article',

    'yiyun.tests.service.match',
]
